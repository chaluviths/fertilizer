...
<body>
    <nav class="navbar navbar-dark bg-dark">
        ...
        <a class="btn btn-lg btn-success text-white pull-right" href="#" role="button">Register</a>
    </nav>
    <div class="container">
        <br><br>
        <div class="row mt-5">  
        ...
        <form action="index.php" method="post" enctype="multipart/form-data" onsubmit="return validateLand()">
            <div class="row mt-5">
